...
Given('que ingreso a la página de OrangeHRM con las credenciales username {string} y password {string}', async (user, password)=> {
...
When('quiero buscar el nuevo empleado con nombre {string}', async (employeeName)=> {
    await pimPage.create_employee("Eliana","Fransis","Villafuerte")
